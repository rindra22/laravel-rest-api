...
namespace Jejookit\RestAPI\Routing;

use Closure;
use Jejookit\RestAPI\Exceptions\ApiException;
use Jejookit\RestAPI\Middleware\ApiMiddleware;
...
class ApiRouter extends Router
{
    ...
    {
        if ($this->container && $this->container->bound('Jejookit\RestAPI\Routing\ApiResourceRegistrar')) {
            $registrar = $this->container->make('Jejookit\RestAPI\Routing\ApiResourceRegistrar');
        }
        else {
...
//             $routes->add($route);
            ...
            // Options route
           // $route = $this->createRoute(['OPTIONS'], $uri, ['uses' => '\Jejookit\RestAPI\Routing\ApiRouter@returnRoute']);
